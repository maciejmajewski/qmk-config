...
[MAC_BASE] = LAYOUT_ansi_84(
     ...
     KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  MO(MAC_FN),    _______,
     KC_LCTL,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 KC_RCMMD, KC_ROPTN, KC_LEFT,  KC_UP,    KC_DOWN,       KC_RGHT),
