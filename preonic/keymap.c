...
[_QWERTY] = LAYOUT_preonic_1x2uC(
  ...
  KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,  KC_N,  KC_M,      KC_COMM,   KC_DOT,  KC_SLSH,          KC_RSHIFT_OR_ENTER,
  MO_QMK,   KC_LCTL,  KC_LALT,  KC_LGUI,  MO_LOWER,    KC_SPC,    MO_RAISE,  KC_LEFT,   KC_UP,   KC_DOWN,          KC_RIGHT
),

[_QMK] = LAYOUT_preonic_1x2uC(
  KC_SLEEP,  _______,     _______,     _______,     _______,     _______,  _______,  _______,  _______,  _______,  _______,  KC_DEL,
